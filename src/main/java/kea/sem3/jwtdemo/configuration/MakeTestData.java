...
public class MakeTestData implements ApplicationRunner {
    ...
    public  void makePlainUsers(){
        ...
        Member memberTest = memberRespository.save(new Member("KW","kw@a.dk","test12","Kurt","Wonnegut","Lyngbyvje 34","Lyngby","2800"));
        ...
        Reservation res1 = new Reservation(LocalDate.of(2022,3,1),carVolvo,memberTest);
        reservationRepository.save(res1);
        Reservation res = reservationRepository.
                findReservationByCar_IdAndRentalDate(carVolvo.getId(),(LocalDate.of(2022,3,1)));
        if(res == null) {
            Reservation res2 = new Reservation(LocalDate.of(2022, 3, 1), carVolvo, memberTest);
            reservationRepository.save(res2);
        } else{
            System.out.println("Car is reserved this day");
        }

        carRepository.save(new Car("a", "a" ,30 , 20));


        memberRespository.save(new Member("gitte","gitte@test.dk","test12","Kurt","Wonnegut","Lyngbyvje 34","Lyngby","2800"));
